...
\begin{subfigure}{\textwidth}
    ...
    \includegraphics[width=0.8\textwidth]{../figures/dkkm_bgn_ver3.pdf} % <-- first figure file
...
\begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{../figures/dkkm_kp_ver3.pdf} % <-- second figure file
...
\begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{../figures/dkkm_gs_ver3.pdf} % <-- second figure file
