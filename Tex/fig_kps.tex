...
\begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{Images (main)/for tex/ipca_bgn_ver3.pdf} % <-- first figure file
...
\begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{Images (main)/for tex/ipca_kp_ver3.pdf} % <-- second figure file
...
\begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.8\textwidth]{Images (main)/for tex/ipca_gs_ver3.pdf} % <-- second figure file
